...
goto check;
    ...
    _height = self.bounds.size.height - drawLineY - self.font.ascender + (- self.font.descender) + self.lineSpacing;
//    CGRect f = self.frame;
//    [self setFrame:CGRectMake(f.origin.x, f.origin.y, f.size.width, _height)];
}
