   ...
   rightButtonTitle:(NSString *)rigthTitle
{
    if (self = [super init]) {
        ...
        [self.alertTitleLabel setBackgroundColor:[UIColor clearColor]];
        ...
        self.alertContentLabel = [[UILabel alloc] initWithFrame:CGRectMake((kAlertWidth - contentLabelWidth) * 0.5, 15, contentLabelWidth, 60)];
        ...
        [self.alertContentLabel setBackgroundColor:[UIColor clearColor]];
        CGFloat y = _alertContentLabel.frame.origin.y + _alertContentLabel.frame.size.height - 15;
        
        _studentIdField = [[LRTextFeild alloc] initWithFrame:CGRectMake(10, y, kAlertWidth - 20, 40)];
        [_studentIdField setPlaceholder:@"学号"];
        [_studentIdField setBackgroundColor:[UIColor whiteColor]];
        _passwordField = [[LRTextFeild alloc] initWithFrame:CGRectMake(10, y + 50, kAlertWidth - 20, 40)];
...
#define kButtonBottomOffset 10.0f
        ...
        [self.leftBtn setBackgroundImage:[UIImage imageWithColor:UIColorFromRGB(0x99cc00)] forState:UIControlStateNormal];
        ...
        self.leftBtn.layer.cornerRadius = self.rightBtn.layer.cornerRadius = 20.0f;
...
- (void)willMoveToSuperview:(UIView *)newSuperview
{
    ...
    if (!self.backImageView) {
        ...
        UITapGestureRecognizer *apGR = [[UITapGestureRecognizer alloc] initWithTarget:self action:@selector(hideKeyBoard)];
        [_backImageView addGestureRecognizer:apGR];
    }
...
- (void)hideKeyBoard
{
    [_studentIdField resignFirstResponder];
